        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="date" class="form-control" id="address" placeholder="1-12-2021" required>
              <div class="invalid-feedback">
      ...
      <div class="col-md-5 col-lg-4 order-md-last">
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          ...
          <span class="badge bg-primary rounded-pill"> <?php 
              ...
              $data = $dbObject->read_salon_bookings("SELECT * FROM `bookings`");
               echo  count($data);
              ?></span>
        </h4>
        ...
        <form class="card p-2">
          ...
          <button class="w-100 btn btn-primary btn-lg my-2" type="submit">Continue to checkout</button>
        </form>
      </div>
    </div>
  </div>
